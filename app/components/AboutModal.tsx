      ...
      >
        <div className="flex flex-col lg:flex-row items-center lg:items-start">
          ...
          <div className="lg:w-1/2 w-full p-4">
            ...
            {/* Change Text here */}
            <p className="text-justify max-w-[60ch] leading-relaxed">Hello! My name is Robert (Robby) Oh, and I&apos;m an aspiring game developer! I graduated from Carnegie Mellon University in 2020 with a B.S. in Statistics and Machine Learning and a minor in Game Design. I also graduated from Northeastern University in 2026 with a Master's in Game Science and Design! I have 2 years of industry experience as a Machine Learning Engineer at Workday, and 2 years as a Software Engineer at Amazon. It&apos;s always been my dream to become a Game Designer since I was a kid. I&apos;ve showcased some of my best games I&apos;ve created here on this portfolio website- let&apos;s connect if you&apos;d like to collaborate with me to create fun, innovative games!
            </p>
            <p className="mt-4 text-justify">Favorite Indie Games (of many): Slay the Spire 2, Return of the Obra Dinn, Omori
            </p>
          </div>
        </div>
      </div>
